                ...
                switch ((string)elements[0].Identifier)
                {
                    ...
                    case "a":
                       ...
                       // MobileParty.MainParty.MoraleExplained.Add(-moraleGainA);
                        ...
                        var meatstorage = MobileParty.MainParty.ItemRoster.GetItemNumber(meat);
                            var grapes = MBObjectManager.Instance.GetObject<ItemObject>("grapes");
                        ...
                        var datefruit = MBObjectManager.Instance.GetObject<ItemObject>("date fruit");
                        ...
                        //If Food Types Exist ========
                            if (grainstorage >= 5)
                             {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(grain, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //string foodtype = new TextObject("grain").ToString();
                            }
                        else if (fishstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(fish, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("fish").ToString();
                            }
                        else if (cheesestorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(cheese, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("cheese").ToString();
                            }
                        else if (butterstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(butter, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("butter").ToString();
                            }
                        else if (meatstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(meat, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("meat").ToString();
                            }
                        else if (grapesstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(grapes, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("grapes").ToString();
                            }
                        else if (olivesstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(olives, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("olives").ToString();
                            }
                        else if (beerstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(beer, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("beer").ToString();
                            }
                        else if (datefruitstorage >= 5)
                            {
                                InformationManager.ShowInquiry(new InquiryData(eventTitle, eventOptionAText, true, false, eventButtonText2, null, null, null), true);
                                MobileParty.MainParty.ItemRoster.AddToCounts(datefruit, -food);
                                MobileParty.MainParty.RecentEventsMorale += moraleGainA;
                                MobileParty.MainParty.MoraleExplained.Add(+moraleGainA);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Leadership, 150);
                                Hero.MainHero.AddSkillXp(DefaultSkills.Charm, 50);
                                //var foodtype = new TextObject("date fruit").ToString();
                            }
                    ...
                    case "b":
                        ...
                        for (int i = 0; i < CharacterObject.All.Count; i++)
                        {
                            ...
                            TaleWorlds.CampaignSystem.Party.PartyScreenManager.OpenScreenAsReceiveTroops(troopRoster, leftPartyName: new TextObject("{cultureclass} Refugees").SetTextVariable("cultureclass", cultureclass), null);
                        ...
                        case "c":
                            ...
                            TaleWorlds.CampaignSystem.Party.PartyScreenManager.OpenScreenAsLoot(emptyTroopRoster, troopRoster2, new TextObject("{cultureclass} Refugees").SetTextVariable("cultureclass", cultureclass), 20, null);
