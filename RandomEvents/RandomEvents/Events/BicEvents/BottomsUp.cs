	...
	public sealed class BottomsUp : BaseEvent
	{
		...
		public override void StartEvent()
		{
			...
			var eventOptionBText = new TextObject(
				   "{=BottomsUp_Event_Choice_2}You look up at your men and give a little smirk, knowing full well you could have crushed this boy's dreams but sometimes it's best to let others have their moment.")
			   .ToString();
