    ...
    public class Robbery : BaseEvent
    {
        ...
        public override void StartEvent()
        {
            ...
            var eventText =new TextObject(
                    "{=Robbery_Event_Text}One evening, while leaving the tavern in {currentSettlement} late at night " +
                    "you decide to take a shortcut back through an alley. You quickly realize that this was a bad idea " +
                    "as you are surrounded by {thugs} thugs who start threatening you. Their leader, {gangLeader}, tells " +
                    "you to hand over any valuables you have on you. Knowing you are outnumbered, you comply and hand " +
                    "over {goldLost} gold to {gangLeader} and the thugs.\n\n{gangLeader} tells the thugs to teach you a " +
                    "lesson that will keep you out of their alley next time. The next few minutes are a blur as you are " +
