    ...
    public class PrisonerTransfer : BaseEvent
    {
        ...
        public override void StartEvent()
        {
            ...
            var eventDescription = new TextObject(
                "{=PrisonerTransfer_Event_Desc}You and your men are traveling near {closestSettlement} when you are approached by a ban of mercenaries from {randomCulture}. They inform you that they were tasked with capturing a bunch of " +
                "soldiers who had deserted from their duty. They were on their way to {closestCastle} with the prisoners but they have not received payment for their job. They are offering you the chance to " +
                "buy some or all of the prisoners for a nice sum of {pricePrPrisoner} gold per prisoner. You look at the prisoners and all you see are young recruits who can " +
                "easily be trained and given a worthy cause to fight for. What do you do?")
            ...
            var eventOption1Hover = new TextObject("{=PrisonerTransfer_Event_Option_1_Hover}You could use ever man").ToString();
            ...
            var eventOptionAText = new TextObject(
                "{=PrisonerTransfer_Event_Choice_1}You tell the mercenary captain that you will take all his prisoners of his hands. You haggle for a few minutes over the price and you end up paying " +
                "{totalGold} gold for all the prisoners.\n\n{pricePrPrisoner} gold * {prisonerForTransfer} men = {totalGold} gold in total.\n\n Once the negotiations have been concluded and the mercenaries has left you make sure to feed your prisoners. They cannot " +
                "thank you enough for taking them in and it does not take long for all the prisoners to swear their allegiance to you.")
            ...
            var eventOptionCText = new TextObject(
                    "{=PrisonerTransfer_Event_Choice_3}You tell him that you don't have room for anymore but you wish him luck on his journeys. You watch on as the mercenaries and the prisoners disappears over a " +
                    "small hill in the distance.")
                .ToString();
