		...
		public override void StartEvent()
		{
			...
			InformationManager.ShowInquiry(
				new InquiryData(EventTitle,
					"You are in your tent late on night when you hear your men starting a commotion. Annoyed you go out and tell them to quite down but as soon as you step foot outside your tent you see what the commotion is about. " +
					...
					$"You ride like a madman towards {closestSettlement} as you know it to be a priest there. As your steed jumps over a fence you fall of and black out.\n" +
