        ...
        public override void StartEvent()
        {
            ...
            if (femaleList.Count != 0)
            {
                ...
                var eventOptionAText = new TextObject(
                        "{=AFlirtatiousEncounter_Event_Choice_1}When she gets over to you the two of you starts talking. You learn that her name is {name} and she's {age} years old. Both of you end up sitting and chatting " +
                        "for a few hours but eventually you both go your separate ways, but not before sharing a warming hug. As you watch her walk away into the night you are left wondering if you'll ever see her again.")
                    .SetTextVariable("name", target.FirstName)
                    .SetTextVariable("age", (int)Math.Round(target.Age))
                    .ToString();

                var eventOptionBText = new TextObject(
                        "{=AFlirtatiousEncounter_Event_Choice_2}When she gets over to you the two of you starts talking. You offer to buy her a drink which she accepts. As the evening progresses the two of you get more and more drunk. " +
                        "You manage to learn that her name is {name} and she's {age} years old. Eventually you are both so drunk that you are thrown out of the bar.\n\nBoth of you giggle as you wobble down " +
                        "the streets of {currentSettlement} while singing songs. Eventually the alcohol starts wearing off and you both decide it was a lovely night. You give each other a tender hug before you go your separate ways. " +
                        "After a few seconds you hear your name being called. “{heroName} wait!” You turn around and see {name} running back to you. She stops just a few inches from you face and gives you a deep and tender kiss on the lips. " +
                ...
                var eventOptionDText = new TextObject(
                        "{=AFlirtatiousEncounter_Event_Choice_4}You cannot help but be a little annoyed as you'd rather drink in peace. When she gets over to you she introduces herself as {name}. It does not take long for you to have insulted her enough " +
                        "so she leave you alone. You may have hurt her feelings but at least  you are able to enjoy the night in peace. A few hours later as you are about to leave you come across {name} again. " +
                        "You tell her that you're sorry for what you said and you didn't mean it as you just wanted to be left alone. She somehow manages to politely and kindly tell you to F**k off.")
                    .SetTextVariable("name", target.FirstName)
                    .SetTextVariable("age", (int)Math.Round(target.Age))
                    .SetTextVariable("heroName", Hero.MainHero.FirstName.ToString())
                    .ToString();
