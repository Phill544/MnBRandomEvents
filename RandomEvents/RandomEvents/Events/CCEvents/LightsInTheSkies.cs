    ...
    public class LightsInTheSkies : BaseEvent
    {
        ...
        public override void StartEvent()
        {
            ...
            var eventText3 =new TextObject(
                    ...
                    "except from the fact they are somewhat smaller and their faces are covered in thick hair. Their " +
                    "ears and noses are for some reason hairless.”\n\n“I lie there unable to move as the creatures poke " +
                    "me with several instruments and take notes, all while I can hear their unrecognizable language. " +
                    "Eventually they put a mask over my mouth and nose and I pass out again.”\n\n“When I come to I am " +
                    "standing in the clearing looking at the light disappearing across the treeline.”")
                .ToString();
            
            var eventText4 =new TextObject(
                    "{=LightsInTheSkies_Event_Text_4}You finish writing and you cannot stop shaking so you leave your " +
                    "tent to get some fresh air. Some of your men are still up and they can see that something is wrong " +
                    "but you assure them that everything is fine. You go to a lookout point in the camp and watch over " +
                    "the land as you try to make sense of this whole situation. You end up standing there for a few " +
                    "minutes.\n\nWhen you decide to leave you swear you can see the same strange light streaking across " +
                    "the sky in the distance one last time.")
                .ToString();
