	...
	public static class PartySetup
	{
		public static MobileParty CreateLooterParty(string partyName = null)
		{
			...
			try
			{
				...
				banditParty = BanditPartyComponent.CreateLooterParty($"randomevent_{banditCultureObject.StringId}_{MBRandom.RandomInt(int.MaxValue)}", closestHideout.OwnerClan, closestHideout, false);
		...
		public static MobileParty CreateBanditParty(string cultureObjectId = null, string partyName = null)
		{
			...
			try
			{
				...
				banditParty = BanditPartyComponent.CreateBanditParty($"randomevent_{banditCultureObject.StringId}_{MBRandom.RandomInt(int.MaxValue)}", Clan.BanditFactions.First(clan => clan.DefaultPartyTemplate == partyTemplate), closestHideout.Hideout, false);
